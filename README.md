...
The process will read messages in JSON format from a RabbitMQ server, parse the messages and process the data. It will generate statistical information of the values retrieved, consisting in the mean, medium, mode, standard deviation, quartiles and minimum/maximum values.
